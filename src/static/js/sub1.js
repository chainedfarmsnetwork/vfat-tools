...
async function main() {
  ...
  const SFN1_CHEF_ADDR = '0x4184Bced3F4F8A9f09eF6d80b9A1d40564CAbBAb'
  const rewardTokenTicker = 'SFN1'
  const SFN1_CHEF = new ethers.Contract(SFN1_CHEF_ADDR, SFN1_CHEF_ABI, App.provider)

  const rewardsPerWeek = (((await SFN1_CHEF.tokenPerBlock()) / 1e18) * 604800) / 3
